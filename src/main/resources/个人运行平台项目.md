...
<mapper namespace="tm.mes.cpms.dao.UserDao">
...
<mapper namespace="tm.mes.cpms.dao.MenuDao">
    <!--映射实体-->
    <resultMap id="menuMap" type="tm.mes.cpms.bean.MainMenu">
        <id column="id"  property="id"></id>
        <result column="title"  property="title"></result>
        <result column="path"  property="path"></result>
        <collection  property="slist" ofType="tm.mes.cpms.bean.SubMenu">
...
```xml
    <select id="getAllUser" resultType="tm.mes.cpms.bean.User">
